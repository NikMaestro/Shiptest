...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	// RADIO_CHANNEL_SOLGOV = FREQ_SOLGOV, // [CELADON-DELETE] - FACTION_RADIO
	RADIO_CHANNEL_WIDEBAND = FREQ_WIDEBAND,
	// RADIO_CHANNEL_CYBERSUN = FREQ_CYBERSUN, // [CELADON-DELETE] - FACTION_RADIO
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	// "[FREQ_SOLGOV]" = RADIO_CHANNEL_SOLGOV, // [CELADON-DELETE] - FACTION_RADIO
	"[FREQ_WIDEBAND]" = RADIO_CHANNEL_WIDEBAND,
	// "[FREQ_SYNDICATE]" = RADIO_CHANNEL_SYNDICATE, // [CELADON-DELETE] - FACTION_RADIO
	// [CELADON-ADD] - FACTION_RADIO
